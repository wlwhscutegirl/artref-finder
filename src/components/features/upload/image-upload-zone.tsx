          ...
          className={`
            ...
            ${disabled
              ...
              : isDragOver
                ...
                : 'border-gray-300 bg-gray-50/30 hover:border-gray-400 hover:bg-orange-50/30'
            }
          `}
        >
          <input
          ...
          <div className="px-3 py-2 flex gap-2">
            ...
            {onApplyToMannequin && (
              <button
                ...
                className="flex-1 px-3 py-1.5 bg-neutral-700 hover:bg-orange-200 rounded-lg text-xs font-medium text-gray-600 cursor-pointer transition-colors"
              >
                마네킹에 적용
              </button>
            )}
