  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-gray-500">
            ...
            <a href="#for-who" className="hover:text-gray-900 transition-colors">추천 대상</a>
      ...
      <section className="relative pt-36 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-7xl font-extrabold leading-[1.05] tracking-tight mb-6">
            <span className="text-gray-900">원하는 포즈를</span>
            <br />
          ...
          <p className="text-lg sm:text-xl text-gray-500 max-w-xl mx-auto mb-12 leading-relaxed">
            ...
            AI가 일치하는 <span className="text-gray-700 font-medium">실사 레퍼런스</span>를 찾아줍니다.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-16">
            ...
            <Link
              href="/mannequin"
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl font-semibold text-base bg-orange-600 hover:bg-orange-500 transition-colors text-white"
            >
              마네킹 움직여보기
            </Link>
            {/* Ghost CTA — 가입 유도 */}
          ...
          <div className="max-w-3xl mx-auto">
            <div
              className="aspect-[16/9] rounded-2xl bg-gray-50 border border-gray-200 flex items-center justify-center"
              aria-label="제품 미리보기 — 추후 실제 스크린샷으로 교체"
            >
              {/* 플레이스홀더 — 마네킹 + 검색결과 UI 시각화 */}
              <div className="text-center">
                <div className="text-4xl mb-3 opacity-40">🦾</div>
                <p className="text-sm text-gray-300">3D 마네킹 → 실사 매칭 미리보기</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ====================================================
          ...
          ==================================================== */}
      <Suspense fallback={
        <div className="py-20 text-center text-gray-300 text-sm" aria-hidden="true">
